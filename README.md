...
You need Python 3.9+ and (optionally, for PDF output) LibreOffice. PyYAML is the only Python dependency.
...
- `identity.yaml` — your personnel number, cost center, bonus-programme membership.
